 ...
 */
var l$3 = Symbol.for("react.element"), n$3 = Symbol.for("react.portal"), p$4 = Symbol.for("react.fragment"), q$4 = Symbol.for("react.strict_mode"), r$1 = Symbol.for("react.profiler"), t$1 = Symbol.for("react.provider"), u$1 = Symbol.for("react.context"), v$3 = Symbol.for("react.forward_ref"), w$2 = Symbol.for("react.suspense"), x$2 = Symbol.for("react.memo"), y$2 = Symbol.for("react.lazy"), z$3 = Symbol.iterator;
function A$3(a) {
...
function M$3(a, b, e) {
  ...
  return { $$typeof: l$3, type: a, key: k2, ref: h, props: c, _owner: K$3.current };
}
function N$2(a, b) {
...
function R$3(a, b, e, d, c) {
  ...
  if (h) return h = a, c = c(h), a = "" === d ? "." + Q$3(h, 0) : d, I$3(c) ? (e = "", null != a && (e = a.replace(P$2, "$&/") + "/"), R$3(c, b, e, "", function(a2) {
    return a2;
  })) : null != c && (O$3(c) && (c = N$2(c, e + (!c.key || h && h.key === c.key ? "" : ("" + c.key).replace(P$2, "$&/") + "/") + a)), b.push(c)), 1;
  h = 0;
  d = "" === d ? "." : d + ":";
  ...
  else if (f2 = A$3(a), "function" === typeof f2) for (a = f2.call(a), g2 = 0; !(k2 = a.next()).done; ) k2 = k2.value, f2 = d + Q$3(k2, g2++), h += R$3(k2, b, e, f2, c);
...
react_production_min$1.Children = { map: S$3, forEach: function(a, b, e) {
  S$3(a, function() {
...
react_production_min$1.cloneElement = function(a, b, e) {
  ...
  if (null != b) {
    ...
    for (f2 in b) J$2.call(b, f2) && !L$3.hasOwnProperty(f2) && (d[f2] = void 0 === b[f2] && void 0 !== g2 ? g2[f2] : b[f2]);
  }
...
function q$3(c, a, g2) {
  ...
  for (b in a) m$3.call(a, b) && !p$3.hasOwnProperty(b) && (d[b] = a[b]);
...
function dg(a, b, c) {
  ...
  c ? (a = bg(a, b, Xf), d.__reactInternalMemoizedMergedChildContext = a, E$1(Wf), E$1(H$2), G$2(H$2, a)) : E$1(Wf);
  G$2(Wf, c);
}
...
function Zh(a, b) {
  var c = M$2, d = Uh(), e = b(), f2 = !He$1(d.memoizedState, e);
...
function ui(a, b, c) {
  ...
  He$1(c, b) || (c = yc(), M$2.lanes |= c, rh |= c, a.baseState = true);
  return b;
}
function vi(a, b) {
  var c = C$2;
...
function dj(a, b, c) {
  ...
  if ("hidden" === d.mode) if (0 === (b.mode & 1)) b.memoizedState = { baseLanes: 0, cachePool: null, transitions: null }, G$2(ej, fj), fj |= c;
  else {
    if (0 === (c & 1073741824)) return a = null !== f2 ? f2.baseLanes | c : c, b.lanes = b.childLanes = 1073741824, b.memoizedState = { baseLanes: a, cachePool: null, transitions: null }, b.updateQueue = null, G$2(ej, fj), fj |= a, null;
    b.memoizedState = { baseLanes: 0, cachePool: null, transitions: null };
    d = null !== f2 ? f2.baseLanes : c;
    G$2(ej, fj);
    fj |= d;
  }
  else null !== f2 ? (d = f2.baseLanes | c, b.memoizedState = null) : d = c, G$2(ej, fj), fj |= d;
  Xi(a, b, e, c);
  return b.child;
}
function gj(a, b) {
...
function oj(a, b, c) {
  var d = b.pendingProps, e = L$2.current, f2 = false, g2 = 0 !== (b.flags & 128), h;
...
function rj(a, b, c, d, e, f2, g2) {
  if (c) {
    if (b.flags & 256) return b.flags &= -257, d = Ki(Error(p$2(422))), sj(a, b, g2, d);
...
function yj(a, b, c) {
  switch (b.tag) {
    ...
    case 10:
      ...
      G$2(Wg, d._currentValue);
      d._currentValue = e;
      break;
    case 13:
      d = b.memoizedState;
      if (null !== d) {
        if (null !== d.dehydrated) return G$2(L$2, L$2.current & 1), b.flags |= 128, null;
...
function Ej(a, b, c) {
  ...
  switch (b.tag) {
        ...
        if (Gg(b)) {
          ...
          for (var g2 in f2) if (f2.hasOwnProperty(g2)) {
            ...
            "children" === g2 ? "string" === typeof h ? d.textContent !== h && (true !== f2.suppressHydrationWarning && Af(d.textContent, h, a), e = ["children", h]) : "number" === typeof h && d.textContent !== "" + h && (true !== f2.suppressHydrationWarning && Af(
              ...
              h,
              a
            ), e = ["children", "" + h]) : ea.hasOwnProperty(g2) && null != h && "onScroll" === g2 && D$2("scroll", d);
          }
          switch (c) {
            case "input":
              Va(d);
    ...
    case 19:
      ...
      if (null !== f2.tail) return b = f2.tail, f2.rendering = b, f2.tail = b.sibling, f2.renderingStartTime = B$2(), b.sibling = null, c = L$2.current, G$2(L$2, d ? c & 1 | 2 : c & 1), b;
      S$2(b);
      return null;
    case 22:
    case 23:
...
function Ij(a, b) {
  ...
  switch (b.tag) {
    ...
    case 3:
      return zh(), E$1(Wf), E$1(H$2), Eh(), a = b.flags, 0 !== (a & 65536) && 0 === (a & 128) ? (b.flags = a & -65537 | 128, b) : null;
    case 5:
      return Bh(b), null;
    case 13:
      E$1(L$2);
  ...
  for (var d = 0 !== (a.mode & 1); null !== V$2; ) {
    ...
    if (22 === e.tag && d) {
      ...
      if (!g2) {
        ...
        var l2 = U$2;
        Jj = g2;
        if ((U$2 = k2) && !l2) for (V$2 = e; null !== V$2; ) g2 = V$2, k2 = g2.child, 22 === g2.tag && null !== g2.memoizedState ? jk(e) : null !== k2 ? (k2.return = g2, V$2 = k2) : jk(e);
...
var lk = Math.ceil, mk = ua.ReactCurrentDispatcher, nk = ua.ReactCurrentOwner, ok = ua.ReactCurrentBatchConfig, K$2 = 0, Q$2 = null, Y$1 = null, Z$1 = 0, fj = 0, ej = Uf(0), T$2 = 0, pk = null, rh = 0, qk = 0, rk = 0, sk = null, tk = null, fk = 0, Gj = Infinity, uk = null, Oi = false, Pi = null, Ri = null, vk = false, wk = null, xk = 0, yk = 0, zk = null, Ak = -1, Bk = 0;
function R$2() {
...
function gi(a, b, c, d) {
  ...
  Ac(a, c, d);
  if (0 === (K$2 & 2) || a !== Q$2) a === Q$2 && (0 === (K$2 & 2) && (qk |= c), 4 === T$2 && Ck(a, Z$1)), Dk(a, d), 1 === c && 0 === K$2 && 0 === (b.mode & 1) && (Gj = B$2() + 500, fg && jg());
}
function Dk(a, b) {
...
function Gk(a, b) {
  ...
  if (0 !== (d & 30) || 0 !== (d & a.expiredLanes) || b) b = Ik(a, d);
    ...
    mk.current = f2;
    K$2 = e;
    null !== Y$1 ? b = 0 : (Q$2 = null, Z$1 = 0, b = T$2);
  }
  if (0 !== b) {
...
function Rk(a) {
  ...
  var b = K$2;
  K$2 |= 1;
  var c = ok.transition, d = C$2;
  try {
    if (ok.transition = null, C$2 = 1, a) return a();
  } finally {
    C$2 = d, ok.transition = c, K$2 = b, 0 === (K$2 & 6) && jg();
  }
}
function Hj() {
  fj = ej.current;
...
function Pk(a, b, c) {
  var d = C$2, e = ok.transition;
  try {
    ok.transition = null, C$2 = 1, Wk(a, b, c, d);
  } finally {
    ok.transition = e, C$2 = d;
  }
  return null;
}
function Wk(a, b, c, d) {
...
function Hk() {
  if (null !== wk) {
    var a = Dc(xk), b = ok.transition, c = C$2;
    try {
      ok.transition = null;
      C$2 = 16 > a ? 16 : a;
...
function fl(a, b, c, d) {
  var e = b.current, f2 = R$2(), g2 = yi(e);
  c = dl(c);
...
class RenderErrorBoundary extends reactExports$1.Component {
  ...
  render() {
    return this.state.error !== void 0 ? /* @__PURE__ */ reactExports$1.createElement(RouteContext.Provider, {
...
function _renderMatches(matches, parentMatches, dataRouterState, future) {
  ...
  return renderedMatches.reduceRight((outlet, match2, index) => {
    ...
    return dataRouterState && (match2.route.ErrorBoundary || match2.route.errorElement || index === 0) ? /* @__PURE__ */ reactExports$1.createElement(RenderErrorBoundary, {
...
function createRoutesFromChildren(children, parentPath) {
  ...
  let routes2 = [];
  reactExports$1.Children.forEach(children, (element, index) => {
...
var f$1 = "undefined" != typeof process && void 0 !== define_process_env_default && (define_process_env_default.REACT_APP_SC_ATTR || define_process_env_default.SC_ATTR) || "data-styled", m$1 = "active", y$1 = "data-styled-version", v$1 = "6.1.12", g = "/*!sc*/\n", S$1 = "undefined" != typeof window && "HTMLElement" in window, w$1 = Boolean("boolean" == typeof SC_DISABLE_SPEEDY ? SC_DISABLE_SPEEDY : "undefined" != typeof process && void 0 !== define_process_env_default && void 0 !== define_process_env_default.REACT_APP_SC_DISABLE_SPEEDY && "" !== define_process_env_default.REACT_APP_SC_DISABLE_SPEEDY ? "false" !== define_process_env_default.REACT_APP_SC_DISABLE_SPEEDY && define_process_env_default.REACT_APP_SC_DISABLE_SPEEDY : "undefined" != typeof process && void 0 !== define_process_env_default && void 0 !== define_process_env_default.SC_DISABLE_SPEEDY && "" !== define_process_env_default.SC_DISABLE_SPEEDY ? "false" !== define_process_env_default.SC_DISABLE_SPEEDY && define_process_env_default.SC_DISABLE_SPEEDY : false), _ = Object.freeze([]), C$1 = Object.freeze({});
...
var T$1 = /(a)(d)/gi, k$1 = 52, j = function(e2) {
  return String.fromCharCode(e2 + (e2 > 25 ? 39 : 97));
};
function x$1(e2) {
  var t2, n2 = "";
  for (t2 = Math.abs(e2); t2 > k$1; t2 = t2 / k$1 | 0) n2 = j(t2 % k$1) + n2;
  return (j(t2 % k$1) + n2).replace(T$1, "$1-$2");
}
...
function Fe(e2) {
  var t2, n2, o2, r2 = C$1, s2 = r2.options, i2 = void 0 === s2 ? C$1 : s2, a2 = r2.plugins, c2 = void 0 === a2 ? _ : a2, l2 = function(e3, o3, r3) {
...
function Ge() {
  return reactExports$1.useContext($e);
}
var We = function() {
  function e2(e3, t2) {
    var n2 = this;
...
function it(e2, r2, s2) {
  ...
  function O2(e3, r3) {
    return function(e4, r4, s3) {
      ...
      var N3 = ie(p3, d3);
      return E3 && (N3 += " " + E3), g3.className && (N3 += " " + g3.className), w3[L$1(S3) && !A$1.has(S3) ? "class" : "className"] = N3, w3.ref = s3, reactExports$1.createElement(S3, w3);
    }(D2, e3, r3);
  }
  O2.displayName = y2;
...
const MotionContext = reactExports$1.createContext({});
const PresenceContext = reactExports$1.createContext(null);
const isBrowser = typeof window !== "undefined";
const useIsomorphicLayoutEffect = isBrowser ? reactExports$1.useLayoutEffect : reactExports$1.useEffect;
const LazyContext = reactExports$1.createContext({ strict: false });
...
function useVisualElement(Component, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  const { visualElement: parent } = reactExports$1.useContext(MotionContext);
  const lazyContext = reactExports$1.useContext(LazyContext);
  const presenceContext = reactExports$1.useContext(PresenceContext);
  const reducedMotionConfig = reactExports$1.useContext(MotionConfigContext).reducedMotion;
  const visualElementRef = reactExports$1.useRef();
  ...
  const initialLayoutGroupConfig = reactExports$1.useContext(SwitchLayoutGroupContext);
  ...
  const wantsHandoff = reactExports$1.useRef(Boolean(props[optimizedAppearDataAttribute] && !window.HandoffComplete));
...
function useCreateMotionContext(props) {
  const { initial, animate } = getCurrentTreeVariants(props, reactExports$1.useContext(MotionContext));
  return reactExports$1.useMemo(() => ({ initial, animate }), [variantLabelsAsDependency(initial), variantLabelsAsDependency(animate)]);
}
...
function createMotionComponent({ preloadedFeatures: preloadedFeatures2, createVisualElement, useRender, useVisualState, Component }) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    return jsxRuntimeExports$1.jsxs(MotionContext.Provider, { value: context, children: [MeasureLayout2 && context.visualElement ? jsxRuntimeExports$1.jsx(MeasureLayout2, { visualElement: context.visualElement, ...configAndProps }) : null, useRender(Component, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic, context.visualElement)] });
  }
  const ForwardRefComponent = reactExports$1.forwardRef(MotionComponent);
  ForwardRefComponent[motionComponentSymbol] = Component;
  return ForwardRefComponent;
}
function useLayoutId({ layoutId }) {
  const layoutGroupId = reactExports$1.useContext(LayoutGroupContext).id;
...
function useSVGProps(props, visualState, _isStatic, Component) {
  const visualProps = reactExports$1.useMemo(() => {
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component, props, ref, { latestValues }, isStatic) => {
    ...
    const elementProps = Component !== reactExports$1.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
    const { children } = props;
    const renderedChildren = reactExports$1.useMemo(() => isMotionValue(children) ? children.get() : children, [children]);
    return reactExports$1.createElement(Component, {
      ...elementProps,
...
const makeUseVisualState = (config) => (props, isStatic) => {
  const context = reactExports$1.useContext(MotionContext);
  const presenceContext = reactExports$1.useContext(PresenceContext);
...
function usePresence() {
  const context = reactExports$1.useContext(PresenceContext);
  if (context === null)
    return [true, null];
  const { isPresent, onExitComplete, register } = context;
  const id2 = reactExports$1.useId();
  reactExports$1.useEffect(() => register(id2), []);
  const safeToRemove = reactExports$1.useCallback(() => onExitComplete && onExitComplete(id2), [id2, onExitComplete]);
...
function MeasureLayout(props) {
  ...
  const layoutGroup = reactExports$1.useContext(LayoutGroupContext);
  return jsxRuntimeExports$1.jsx(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: reactExports$1.useContext(SwitchLayoutGroupContext), isPresent, safeToRemove });
}
...
const createDomVisualElement = (Component, options) => {
  return isSVGComponent(Component) ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component !== reactExports$1.Fragment
  });
};
const layout = {
  layout: {
...
const transitionSettings$2 = {
  common: { duration: 0.6, ease: "easeInOut" },
  hover: { duration: 0.3, ease: "easeInOut" },
  bounce: { duration: 0.7, ease: "easeOut" }
};
...
`;
const Heading$2 = dt(motion.h1)`
  margin-bottom: 2rem;
  font-size: 2.5rem;
  color: #212529;
  font-weight: 700;
  letter-spacing: 1.5px;
  transition: color ${transitionSettings$2.hover.duration}s
      ${transitionSettings$2.hover.ease},
    transform ${transitionSettings$2.hover.duration}s
      ${transitionSettings$2.hover.ease};
...
`;
const Section$1 = dt(motion.section)`
  width: 90%;
  max-width: 800px;
  text-align: left;
  margin-bottom: 2rem;
...
`;
const SectionTitle$1 = dt(motion.h2)`
  font-size: 2rem;
  color: #495057;
  margin-bottom: 1rem;
  opacity: 0;
...
const AboutUs = () => /* @__PURE__ */ jsxRuntimeExports$1.jsxs(
  Container$2,
  {
    initial: { opacity: 0 },
    animate: { opacity: 1 },
    transition: { duration: transitionSettings$2.common.duration },
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports$1.jsxs(
        Section$1,
        {
          ...
          transition: { duration: transitionSettings$2.common.duration, delay: 0.4 },
          children: [
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(
              SectionTitle$1,
              {
                ...
                animate: "visible",
                variants: sectionVariants,
                transition: { ...transitionSettings$2.bounce, delay: 0.2 },
            ...
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(
              Paragraph$2,
              {
                ...
                transition: { ...transitionSettings$2.bounce, delay: 0.4 },
                children: "Fondata nel 2023, CodexCircle è un'azienda innovativa specializzata nella creazione di soluzioni digitali su misura. Siamo un team di professionisti appassionati di tecnologia e design, impegnati a trasformare le idee dei nostri clienti in progetti di successo."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(
              SectionTitle$1,
              {
                ...
                animate: "visible",
                variants: sectionVariants,
                transition: { ...transitionSettings$2.bounce, delay: 0.6 },
            ...
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(
              Paragraph$2,
              {
                ...
                animate: "visible",
                variants: paragraphVariants,
                transition: { ...transitionSettings$2.bounce, delay: 0.8 },
                children: "La nostra missione è fornire servizi tecnologici di alta qualità che migliorano l'efficienza e la visibilità delle aziende. Puntiamo a creare soluzioni personalizzate che rispondano alle esigenze specifiche di ciascun cliente, garantendo risultati eccellenti e innovativi."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(
              SectionTitle$1,
              {
                ...
                animate: "visible",
                variants: sectionVariants,
                transition: { ...transitionSettings$2.bounce, delay: 1 },
                children: "I Nostri Valori"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(
              Paragraph$2,
              {
                ...
                animate: "visible",
                variants: paragraphVariants,
                transition: { ...transitionSettings$2.bounce, delay: 1.2 },
                children: "In CodexCircle, ci guidano i valori di integrità, innovazione e collaborazione. Crediamo nell'importanza di un'etica lavorativa trasparente e nella capacità di lavorare insieme per raggiungere gli obiettivi comuni. Ogni progetto è un'opportunità per dimostrare la nostra dedizione al successo dei clienti."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(
              SectionTitle$1,
              {
                ...
                animate: "visible",
                variants: sectionVariants,
                transition: { ...transitionSettings$2.bounce, delay: 1.4 },
            ...
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(
              Paragraph$2,
              {
                ...
                animate: "visible",
                variants: paragraphVariants,
                transition: { ...transitionSettings$2.bounce, delay: 1.6 },
                children: "Il nostro team è composto da esperti in vari ambiti, tra cui sviluppo software, design UX/UI, e gestione dei progetti. Ogni membro del team porta con sé una vasta esperienza e una passione per l'innovazione, lavorando in sinergia per garantire risultati di alta qualità e superare le aspettative dei nostri clienti."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(
              SectionTitle$1,
              {
                ...
                animate: "visible",
                variants: sectionVariants,
                transition: { ...transitionSettings$2.bounce, delay: 1.8 },
            ...
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(
              Paragraph$2,
              {
                ...
                animate: "visible",
                variants: paragraphVariants,
                transition: { ...transitionSettings$2.bounce, delay: 2 },
                children: "Offriamo una gamma completa di servizi, inclusi sviluppo web e mobile, design personalizzato, e consulenza tecnologica. Ogni servizio è progettato per soddisfare le specifiche esigenze dei nostri clienti e contribuire al loro successo a lungo termine."
              }
            )
          ]
        }
...
const data = {
  title: "Contatti 📫",
  email: "info@codexcircle.it",
  text: "Vi consigliamo l'invio di una mail o di scriverci tramite uno dei link social",
  phone: "375 853 0427",
  socialMedia: [
    {
      name: "Instagram",
      url: "https://instagram.com/codexcircle",
      icon: /* @__PURE__ */ jsxRuntimeExports$1.jsx(FaInstagram, {})
    },
    {
      name: "Telegram",
      url: "https://t.me/codexcircle",
      // Replace with your Telegram link
      icon: /* @__PURE__ */ jsxRuntimeExports$1.jsx(FaTelegram, {})
    },
    {
      name: "WhatsApp",
      url: "https://wa.me/00393758530427",
      // Replace with your WhatsApp link
      icon: /* @__PURE__ */ jsxRuntimeExports$1.jsx(FaWhatsapp, {})
    }
  ]
};
...
function R(a, b, e, d, c) {
  ...
  else if (f2 = A(a), "function" === typeof f2) for (a = f2.call(a), g2 = 0; !(k2 = a.next()).done; ) k2 = k2.value, f2 = d + Q(k2, g2++), h += R(k2, b, e, f2, c);
  else if ("object" === k2) throw b = String(a), Error("Objects are not valid as a React child (found: " + ("[object Object]" === b ? "object with keys {" + Object.keys(a).join(", ") + "}" : b) + "). If you meant to render a collection of children, use an array instead.");
  return h;
}
function S(a, b, e) {
...
react_production_min.cloneElement = function(a, b, e) {
  ...
  if (null != b) {
    ...
    void 0 !== b.key && (c = "" + b.key);
    if (a.type && a.type.defaultProps) var g2 = a.type.defaultProps;
    for (f2 in b) J.call(b, f2) && !L.hasOwnProperty(f2) && (d[f2] = void 0 === b[f2] && void 0 !== g2 ? g2[f2] : b[f2]);
  }
  var f2 = arguments.length - 2;
  if (1 === f2) d.children = e;
  else if (1 < f2) {
...
`;
const GradientAnimationStyle = () => /* @__PURE__ */ jsxRuntimeExports$1.jsx("style", { children: gradientAnimation });
const ContactPage = () => {
  const { title, text, email, phone, socialMedia } = data;
  return /* @__PURE__ */ jsxRuntimeExports$1.jsxs(jsxRuntimeExports$1.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports$1.jsx(GradientAnimationStyle, {}),
    /* @__PURE__ */ jsxRuntimeExports$1.jsx(
      motion.div,
      {
        variants: animationVariants$1.container,
        initial: "hidden",
        animate: "visible",
        style: containerStyle,
        children: /* @__PURE__ */ jsxRuntimeExports$1.jsxs(ClassicContainer, { title, content: text, id: "contact", children: [
          /* @__PURE__ */ jsxRuntimeExports$1.jsx(
            motion.h1,
            {
              variants: animationVariants$1.text,
              initial: "hidden",
              animate: "visible",
              style: titleStyle,
              children: title
          ...
          /* @__PURE__ */ jsxRuntimeExports$1.jsx(
            motion.a,
            {
              variants: animationVariants$1.email,
              initial: "hidden",
              animate: "visible",
              whileHover: hoverEffect$1,
              whileTap: tapEffect$1,
              href: `mailto:${email}`,
              style: linkStyle,
          ...
          phone && /* @__PURE__ */ jsxRuntimeExports$1.jsxs(
            motion.a,
            {
              variants: animationVariants$1.phone,
              initial: "hidden",
              animate: "visible",
              whileHover: hoverEffect$1,
              whileTap: tapEffect$1,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports$1.jsx("span", { style: phoneIconStyle, children: "📞" }),
                phone
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports$1.jsx(
            motion.div,
            {
              variants: animationVariants$1.socialMedia,
              initial: "hidden",
              animate: "visible",
              style: socialMediaContainerStyle,
              children: socialMedia.map(({ name, url, icon }) => /* @__PURE__ */ jsxRuntimeExports$1.jsx(
                motion.a,
                {
                  href: url,
                  target: "_blank",
...
const servicesValues = [
  {
    ...
    description: "Creiamo siti web su misura per le tue esigenze, dall'e-commerce ai siti aziendali, con design moderni e performance ottimizzate. Ogni progetto è personalizzato per garantire risultati eccezionali e un'esperienza utente senza pari."
  },
  {
    title: "Sviluppo Software",
    description: "Sviluppiamo applicazioni software personalizzate che spaziano dalle soluzioni desktop a quelle mobile. Le nostre applicazioni sono progettate per migliorare la produttività e l'efficienza, con un'interfaccia intuitiva e funzionalità avanzate."
  },
  {
    title: "Consulenza Informatica",
    description: "Offriamo consulenza informatica per ottimizzare i tuoi sistemi e gestire la sicurezza dei dati. Analizziamo le tue esigenze tecnologiche e pianifichiamo strategie su misura per migliorare le tue operazioni aziendali."
  },
  {
    title: "Manutenzione e Supporto",
    description: "Forniamo servizi di manutenzione e supporto continuo per garantire il corretto funzionamento e aggiornamento delle tue soluzioni IT. Il nostro supporto proattivo minimizza i tempi di inattività e mantiene i tuoi sistemi sempre efficienti."
  }
];
const transitionSettings$1 = {
  common: { duration: 0.6, ease: "easeInOut" },
  hover: { duration: 0.3, ease: "easeInOut" }
};
const PageContainer = dt(motion.div)`
  text-align: center;
  padding: 3rem 2rem;
  min-height: 100vh;
  display: flex;
...
`;
const MainHeading = dt(motion.h1)`
  margin-bottom: 2rem;
  font-size: 3.5rem;
  color: #212529;
  font-weight: 700;
  letter-spacing: 1px;
  transition: color ${transitionSettings$1.hover.duration}s
      ${transitionSettings$1.hover.ease},
    transform ${transitionSettings$1.hover.duration}s
      ${transitionSettings$1.hover.ease},
    text-shadow ${transitionSettings$1.hover.duration}s
      ${transitionSettings$1.hover.ease};
...
`;
const ImageWrapper = dt(motion.div)`
  margin: 2rem 0;
  display: flex;
  justify-content: center;
`;
const ResponsiveImage = dt(motion.img)`
  width: 60%;
  max-width: 500px;
  border-radius: 12px;
  box-shadow: 0 6px 15px rgba(0, 0, 0, 0.2);
  transition: transform ${transitionSettings$1.hover.duration}s
      ${transitionSettings$1.hover.ease},
    box-shadow ${transitionSettings$1.hover.duration}s
      ${transitionSettings$1.hover.ease};
...
`;
const SectionHeading = dt(motion.h2)`
  color: #495057;
  font-size: 2.8rem;
  font-weight: 600;
  margin-top: 3rem;
...
`;
const TextParagraph = dt(motion.p)`
  font-size: 1.4rem;
  line-height: 1.7;
  color: #495057;
  text-align: center;
  ...
  margin-top: 1rem;
  opacity: 0;
  transition: opacity ${transitionSettings$1.common.duration}s
    ${transitionSettings$1.common.ease};
`;
const ServiceList = dt(motion.ul)`
  font-size: 1.2rem;
  line-height: 1.6;
  color: #495057;
  padding: 0;
  ...
  list-style: none;
`;
const ServiceItem$1 = dt(motion.li)`
  margin-bottom: 1.5rem;
  position: relative;
  padding: 1rem 1.5rem;
  opacity: 0;
  transform: translateY(20px);
  transition: background-color ${transitionSettings$1.hover.duration}s
      ${transitionSettings$1.hover.ease},
    color ${transitionSettings$1.hover.duration}s ${transitionSettings$1.hover.ease},
    transform ${transitionSettings$1.hover.duration}s
      ${transitionSettings$1.hover.ease};
  background: #ffffff;
  border-radius: 8px;
...
`;
const HoverImage = ({ alt, src }) => /* @__PURE__ */ jsxRuntimeExports$1.jsx(
  ResponsiveImage,
  {
    src,
    alt,
...
const Homepage = () => /* @__PURE__ */ jsxRuntimeExports$1.jsxs(
  PageContainer,
  {
    initial: { opacity: 0 },
    animate: { opacity: 1 },
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports$1.jsx(
        MainHeading,
        {
          ...
          animate: { y: 0, opacity: 1 },
          transition: { duration: 0.8 },
          children: "Benvenuti a CodexCircle"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports$1.jsx(
        ImageWrapper,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports$1.jsx(HoverImage, { alt: "Logo di CodexCircle", src: "./temp.png" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports$1.jsx(
        SectionHeading,
      ...
      /* @__PURE__ */ jsxRuntimeExports$1.jsx(
        TextParagraph,
        {
          ...
          children: "CodexCircle è un'azienda specializzata nella creazione di siti web e software su misura. Con un team di esperti nel settore della tecnologia, offriamo soluzioni innovative e personalizzate per soddisfare le esigenze dei nostri clienti. La nostra missione è trasformare le idee in realtà digitali, migliorando l'efficienza e la visibilità delle aziende attraverso tecnologie avanzate e design accattivanti."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports$1.jsx(
        SectionHeading,
      ...
      /* @__PURE__ */ jsxRuntimeExports$1.jsx(
        ServiceList,
        {
          ...
          animate: { opacity: 1 },
          transition: { duration: 0.6, delay: 0.4 },
          children: servicesValues.map((service, index) => /* @__PURE__ */ jsxRuntimeExports$1.jsx(
            ServiceItem$1,
            {
...
const Container$1 = dt(motion.div)`
  ...
  overflow-x: hidden;
`;
const Heading$1 = dt(motion.h1)`
  margin-bottom: 2rem;
  font-size: 2.5rem;
  color: #212529;
  font-weight: 700;
  letter-spacing: 1.5px;
  transition: color ${transitionSettings.common.duration}s
      ${transitionSettings.common.ease},
    transform ${transitionSettings.common.duration}s
      ${transitionSettings.common.ease};
...
const Paragraph$1 = dt.p`
  ...
  margin-bottom: 1rem;
`;
const PrivacyPolicy = () => /* @__PURE__ */ jsxRuntimeExports$1.jsxs(
  Container$1,
  {
    initial: { opacity: 0 },
    animate: { opacity: 1 },
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports$1.jsx(
        Heading$1,
        {
          ...
          animate: { y: 0, opacity: 1 },
          transition: { duration: 0.8 },
          children: "Informativa sulla Privacy"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports$1.jsxs(
        Section,
        {
          ...
          transition: { duration: 0.6, delay: 0.4 },
          children: [
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(SectionTitle, { children: "1. Introduzione" }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(Paragraph$1, { children: "La presente Informativa sulla Privacy descrive come gestiamo la privacy degli utenti del nostro sito web. In particolare, desideriamo informarvi che non raccogliamo dati personali attraverso questo sito." }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(SectionTitle, { children: "2. Dati Raccolti" }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(Paragraph$1, { children: "In quanto non raccogliamo dati personali tramite il nostro sito web, non trattiamo né conserviamo alcun dato personale degli utenti." }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(SectionTitle, { children: "3. Utilizzo dei Dati" }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(Paragraph$1, { children: "Poiché non raccogliamo dati personali, non utilizziamo né elaboriamo dati degli utenti." }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(SectionTitle, { children: "4. Protezione dei Dati" }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(Paragraph$1, { children: "Non essendoci raccolta di dati personali, non abbiamo misure specifiche di protezione da adottare in merito a dati non raccolti." }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(SectionTitle, { children: "5. Condivisione dei Dati" }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(Paragraph$1, { children: "Non condividiamo dati personali con terze parti, poiché non raccogliamo dati personali tramite il nostro sito web." }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(SectionTitle, { children: "6. Diritti dell'Interessato" }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(Paragraph$1, { children: "Poiché non raccogliamo dati personali, non vi sono diritti da esercitare in merito alla gestione dei dati." }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(SectionTitle, { children: "7. Modifiche all'Informativa" }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(Paragraph$1, { children: "Ci riserviamo il diritto di aggiornare questa informativa sulla privacy in qualsiasi momento. Le modifiche saranno pubblicate su questa pagina e, se necessario, vi informeremo tramite email." }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(SectionTitle, { children: "8. Contatti" }),
            /* @__PURE__ */ jsxRuntimeExports$1.jsxs(Paragraph$1, { children: [
              "Per qualsiasi domanda o richiesta riguardante questa informativa, potete contattarci all'indirizzo email:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports$1.jsx("a", { href: "mailto:privacy@codexcircle.it", children: "privacy@codexcircle.it" })
            ] })
          ]
        }
      )
...
const ClassicSpacer = ({ padding = 30 }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding } });
};
...
const OuterContainer = dt(motion.div)`
  margin: 0 auto;
  padding: 80px 20px;
  border-radius: 12px;
...
`;
const ServiceCard = dt(motion.div)`
  font-size: 1.3rem;
  color: #34495e;
  text-align: left;
  line-height: 1.6;
...
`;
const ResponsiveGrid = dt(motion.div)`
  display: grid;
  gap: 40px;
...
`;
const ServiceItem = dt(ServiceCard)`
  padding: 15px;
  text-align: center;
`;
const ServiceItemComponent = ({
  ...
  ServiceItem,
  {
    ...
    animate: "visible",
    children: [
      /* @__PURE__ */ jsxRuntimeExports$1.jsx("strong", { children: title }),
      /* @__PURE__ */ jsxRuntimeExports$1.jsx("p", { style: { fontSize: "1.1rem", color: "#7f8c8d", marginTop: "10px" }, children: description })
    ]
  }
);
const ServicesPage = () => {
  const gridRef = reactExports$1.useRef(null);
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports$1.jsx(
          ClassicContainer,
          {
            ...
            id: "services",
            maxHeight: "100%",
            children: /* @__PURE__ */ jsxRuntimeExports$1.jsxs(InnerContainer, { ref: gridRef, children: [
              /* @__PURE__ */ jsxRuntimeExports$1.jsx(
                Title,
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports$1.jsx(ClassicSpacer, { padding: 20 })
      ]
    }
  );
};
const routes = [
  {
    path: "/",
    text: "Home",
    element: /* @__PURE__ */ jsxRuntimeExports$1.jsx(Homepage, {}),
    showNavbar: true,
    showFooter: true,
    showInNavbar: true,
    showInFooter: false,
    showInSize: ["large", "medium", "small"]
  },
  {
    path: "/about",
    text: "About us",
    element: /* @__PURE__ */ jsxRuntimeExports$1.jsx(AboutUs, {}),
    showNavbar: true,
    showFooter: true,
    showInNavbar: true,
    showInFooter: false,
  ...
  },
  {
    path: "/services",
    text: "Services",
    element: /* @__PURE__ */ jsxRuntimeExports$1.jsx(ServicesPage, {}),
    showNavbar: true,
    showFooter: true,
    showInNavbar: true,
    showInFooter: true,
  ...
  },
  {
    path: "/contact",
    text: "Contact us",
    element: /* @__PURE__ */ jsxRuntimeExports$1.jsx(ContactPage, {}),
    showNavbar: true,
    showFooter: true,
    showInNavbar: true,
    showInFooter: true,
  ...
  },
  {
    path: "/privacy",
    text: "Privacy",
    element: /* @__PURE__ */ jsxRuntimeExports$1.jsx(PrivacyPolicy, {}),
    showNavbar: true,
    showFooter: true,
    showInNavbar: false,
    showInFooter: true,
...
const bounceAnimation = mt`
  0%, 100% { transform: translateY(0); }
  50% { transform: translateY(-10px); }
`;
const slideInAnimation = mt`
  0% { transform: translateX(-20px); opacity: 0; }
  100% { transform: translateX(0); opacity: 1; }
`;
const moveBackground = mt`
  0% { background-position: 0 0; }
...
const Container = dt.div`
  ...
  @media (max-width: 768px) {
    height: 150px; // Adjust height for tablets and smaller devices
    padding: 15px;
  }

  @media (max-width: 480px) {
    height: 120px; // Further adjust height for mobile devices
    padding: 10px;
  }
`;
const Heading = dt(motion.h1)`
  font-size: clamp(
    1.5rem,
    5vw,
    2.5rem
  ...
  @media (max-width: 768px) {
    font-size: clamp(1.2rem, 4vw, 2rem); // Adjusted for tablets
  }

  @media (max-width: 480px) {
    font-size: clamp(1rem, 4vw, 1.7rem); // Further adjusted for mobile
  }
`;
const Paragraph = dt(motion.p)`
  font-size: clamp(0.9rem, 3vw, 1.3rem); // Adjusted for better readability
  color: #fff;
  margin: 0;
  max-width: 90%;
  line-height: 1.5;
  ...
  @media (max-width: 768px) {
    font-size: clamp(0.8rem, 3vw, 1.1rem); // Adjusted for tablets
  }

  @media (max-width: 480px) {
    font-size: clamp(0.7rem, 3vw, 1rem); // Further adjusted for mobile
  }
`;
const AnimatedBackground = dt.div`
  ...
  animation: ${lt`
      ${moveBackground} 15s ease infinite`}, ${lt`
...
const WorkInProgress = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: "hidden", animate: "visible", variants: containerVariants, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedBackground, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Heading, { custom: 0, variants: textVariants, children: "🚧 Work in Progress 🚧" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Paragraph, { custom: 1, variants: textVariants, children: "We are currently working hard to improve this section." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Paragraph, { custom: 2, variants: textVariants, children: "Please check back later!" })
  ] }) });
};
const NavbarContainer$1 = dt.nav`
  display: flex;
  align-items: center;
  justify-content: center;
  ...
  box-sizing: border-box;
`;
const NavLink$1 = dt(motion(Link))`
...
const Breadcrumb = ({ routes: routes2 }) => /* @__PURE__ */ jsxRuntimeExports$1.jsx(NavbarContainer$1, { children: /* @__PURE__ */ jsxRuntimeExports$1.jsx(NavbarContent$1, { children: routes2.map((route, index) => /* @__PURE__ */ jsxRuntimeExports$1.jsx(
  NavLink$1,
  {
    to: route.path,
    initial: "hidden",
    animate: "visible",
    variants: linkVariants$1,
    custom: index,
    children: route.text
  },
  route.path
)) }) });
const Navbar$1 = () => /* @__PURE__ */ jsxRuntimeExports$1.jsx(Breadcrumb, { routes: routes.filter((route) => route.showInNavbar) });
const fadeInUp = {
  initial: { y: 30, opacity: 0, scale: 0.95 },
  animate: { y: 0, opacity: 1, scale: 1 }
};
const fadeInUpTransition = { duration: 1, ease: "easeOut" };
const hoverEffect = {
  scale: 1.05,
  color: "#007bff",
...
const socialHoverEffects = {
  facebook: { color: "#1877f2" },
  twitter: { color: "#1da1f2" },
  instagram: { color: "#e4405f" }
};
const FooterContainer = dt(motion.footer)`
  text-align: center;
  padding: 40px 20px;
  background-color: #fff;
...
`;
const RouteLink = dt(motion(Link))`
  text-decoration: none;
  color: #333;
  font-size: 14px;
  margin: 0 15px;
...
`;
const SocialLinks = dt.div`
  display: flex;
  justify-content: center;
  gap: 20px;
  margin-bottom: 20px;
`;
const SocialIcon = dt(motion.a)`
  color: inherit;
  font-size: 24px;
  text-decoration: none;
  transition: color 0.3s ease, transform 0.3s ease;
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports$1.jsxs(jsxRuntimeExports$1.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports$1.jsx(ClassicSpacer, { padding: 30 }),
    /* @__PURE__ */ jsxRuntimeExports$1.jsxs(
      FooterContainer,
      {
        initial: "initial",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports$1.jsx(
            ContactLink,
            {
              href: "mailto:info@codexcircle.it",
              "aria-label": "Email",
              whileHover: hoverEffect,
              whileTap: tapEffect,
              children: "info@codexcircle.it"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports$1.jsx("div", { children: footerRoutes.map((route) => /* @__PURE__ */ jsxRuntimeExports$1.jsx(
            RouteLink,
            {
              to: route.path,
              "aria-label": route.text,
              whileHover: { color: "#007bff", transition: { duration: 0.3 } },
              children: route.text
            },
            route.path
          )) }),
          /* @__PURE__ */ jsxRuntimeExports$1.jsx(ClassicSpacer, { padding: 10 }),
          /* @__PURE__ */ jsxRuntimeExports$1.jsxs(SocialLinks, { children: [
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(
              SocialIcon,
              {
                href: "https://facebook.com/codexcircle",
                target: "_blank",
                rel: "noopener noreferrer",
                "aria-label": "Facebook",
                whileHover: socialHoverEffects.facebook,
                children: /* @__PURE__ */ jsxRuntimeExports$1.jsx(FaFacebook, {})
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(
              SocialIcon,
              {
                href: "https://twitter.com/codexcircle",
                target: "_blank",
                rel: "noopener noreferrer",
                "aria-label": "Twitter",
                whileHover: socialHoverEffects.twitter,
                children: /* @__PURE__ */ jsxRuntimeExports$1.jsx(FaTwitter, {})
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports$1.jsx(
              SocialIcon,
              {
                href: "https://instagram.com/codexcircle",
                target: "_blank",
                rel: "noopener noreferrer",
                "aria-label": "Instagram",
                whileHover: socialHoverEffects.instagram,
                children: /* @__PURE__ */ jsxRuntimeExports$1.jsx(FaInstagram, {})
              }
            )
          ] })
        ]
...
const NavLink = dt(motion(Link))`
  ...
  @media (max-width: 768px) {
    ...
    margin: 2px 0; // Reduced vertical margin for mobile
  }
`;
const NavbarContent = dt.div.attrs(({ open }) => ({
  style: {
...
const Navbar = ({ routes: routes2 }) => {
  const [open, setOpen] = reactExports$1.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports$1.jsxs(NavbarContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports$1.jsxs(Hamburger, { onClick: () => setOpen(!open), children: [
      /* @__PURE__ */ jsxRuntimeExports$1.jsx("div", {}),
      /* @__PURE__ */ jsxRuntimeExports$1.jsx("div", {}),
      /* @__PURE__ */ jsxRuntimeExports$1.jsx("div", {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports$1.jsx(NavbarContent, { open, children: routes2.map((route, index) => /* @__PURE__ */ jsxRuntimeExports$1.jsx(
      NavLink,
      {
        to: route.path,
        initial: "hidden",
...
const MobileNavbar = () => /* @__PURE__ */ jsxRuntimeExports$1.jsx(Navbar, { routes: routes.filter((route) => route.showInNavbar) });
const PageTemplate = ({ route }) => {
  const { showNavbar, showFooter } = route;
  document.title = route.text;
  const [isMobile, setIsMobile] = reactExports$1.useState(window.innerWidth < 768);
  reactExports$1.useEffect(() => {
    const handleResize = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports$1.jsxs(jsxRuntimeExports$1.Fragment, { children: [
    showNavbar && (isMobile ? /* @__PURE__ */ jsxRuntimeExports$1.jsx(MobileNavbar, {}) : /* @__PURE__ */ jsxRuntimeExports$1.jsx(Navbar$1, {})),
    /* @__PURE__ */ jsxRuntimeExports$1.jsxs(
      "div",
      {
        style: {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports$1.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports$1.jsx(WorkInProgress, {}) }),
          /* @__PURE__ */ jsxRuntimeExports$1.jsx(ClassicSpacer, { padding: 10 }),
          /* @__PURE__ */ jsxRuntimeExports$1.jsx(
            "main",
            {
          ...
          showFooter && /* @__PURE__ */ jsxRuntimeExports$1.jsx(Footer, {})
        ]
      }
    )
  ] });
};
const root = /* @__PURE__ */ jsxRuntimeExports$1.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports$1.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports$1.jsx(Routes, { children: routes.map((route, index) => {
  return /* @__PURE__ */ jsxRuntimeExports$1.jsx(
    Route,
    {
      path: route.path,
      element: /* @__PURE__ */ jsxRuntimeExports$1.jsx(PageTemplate, { route })
    },
    index
  );
}) }) }) });
...
if (rootElem) {
  const rootCreated = createRoot(rootElem);
  rootCreated.render(root);
}
